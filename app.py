    ...
    if request.method == "POST":
        ...
        for key in request.form:
            if key.startswith("pergunta"):
                ...
                cursor.execute("INSERT INTO respostas (aluno_nome, professor_id, pergunta, resposta, sugestao) VALUES (%s,%s,%s,%s,%s)",
...
def admin():
    ...
    cursor.execute("""
        SELECT p.id, p.nome, AVG(r.resposta) as media
        FROM professores p
